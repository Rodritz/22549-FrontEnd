...
function Navbar (titulo,fn) {  /*entre parentesis invoco el 
                            parametro que le cargue a la funcion (puedo ponerle cualquie nombre)
                            y tambien puedo invocar una funcion(puedo ponerle cualquier nombre)*/
    console.log(titulo);
    //fn();//callback-->invoco la funcion que pase por parametro
